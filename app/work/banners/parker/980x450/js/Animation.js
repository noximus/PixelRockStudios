var BanTimeline = {
  ...
  init: function () {
    ...
    TweenLite.to(f3_img1, 0,{scaleX: 3.5,scaleY: 3.5, top:-90, left:250,rotation:0});    
  ...
  frame5: function () {
    TweenLite.to(f4_img1, 1, {opacity:1, display: 'block' ,left:225,top:10, width:200, ease: Quad.easeOut});
    TweenLite.to(f4_img2, 1, {opacity:1, display: 'block' ,top:-100,left:-160,scaleX: .7,scaleY: .7, ease: Quad.easeOut});
